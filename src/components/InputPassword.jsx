    ...
    return (
        <div className="flex">
            <input
                ...
                type="password"
                className={`${error && "border-red-500"} bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-[8px_0_0_8px] focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5`}
            />
            <button
                type="button"
                onClick={(e) => {
                    if (passwordInputRef.current?.getAttribute("type") === "password") {
                ...
                className="!text-dark px-3 bg-gray-100 border border-l-0 border-gray-300 rounded-[0_8px_8px_0]"
            >
